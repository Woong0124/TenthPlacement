...
#define UE_PROJECT_NAME Tenth_Tutorial
#define UE_TARGET_NAME Tenth_TutorialEditor
#define UE_MODULE_NAME "Tenth_Tutorial"
...
#define TENTH_TUTORIAL_API DLLEXPORT
